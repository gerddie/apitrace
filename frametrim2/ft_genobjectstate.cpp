...
GenObjectState::GenObjectState(GLint glID, const trace::Call &gen_call):
...
SizedObjectState::SizedObjectState(GLint glID, const trace::Call& gen_call, EAttachmentType at):
